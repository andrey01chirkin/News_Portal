...
INSTALLED_APPS = [
    'modeltranslation',  # Важно! Перед 'django.contrib.admin'
...
MIDDLEWARE = [
    ...
    'news_portal.middlewares.timezone_middleware.TimezoneMiddleware',
]
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'news_portal.context_processors.timezone_context',  # Добавляем сюда
            ],
        },
    },
]
